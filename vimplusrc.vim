...
" 该配置原始作者：https://github.com/chxuan/vimplus
...
nnoremap <leader>ve :edit ~/.config/nvim/vimplusrc.vim<cr>
nnoremap <leader>vc :edit ~/.config/nvim/vimrc.custom.config<cr>
nnoremap <leader>vp :edit ~/.config/nvim/vimrc.custom.plugins<cr>

" 查看vimplus的help文件
nnoremap <leader>h :view +let\ &l:modifiable=0 ~/.config/nvim/README.md<cr>
